// Code generated by "stringer -type=fileType,symbolType,mode,refType"; DO NOT EDIT.
...
const _mode_name = "voidlvaluervalueaggRvalueconstLvalueconstRvalue"

var _mode_index = [...]uint8{0, 4, 10, 16, 25, 36, 47}
...
const _refType_name = "refInvalidrefFuncrefMemrefData"

var _refType_index = [...]uint8{0, 10, 17, 23, 30}

func (i refType) String() string {
	if i < 0 || i >= refType(len(_refType_index)-1) {
		return "refType(" + strconv.FormatInt(int64(i), 10) + ")"
	}
	return _refType_name[_refType_index[i]:_refType_index[i+1]]
}
