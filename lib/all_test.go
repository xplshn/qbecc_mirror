...
// 2025-07-04
//	all_test.go:254: CompCert-3.6/test/c: files=24 gcc fails=8 skipped=9 failed=0 passed=7
//	all_test.go:254: gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute: files=1506 gcc fails=26 skipped=625 failed=0 passed=855
//	all_test.go:254: tcc-0.9.27/tests/tests2: files=88 gcc fails=8 skipped=18 failed=0 passed=62
